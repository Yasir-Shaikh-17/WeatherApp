...
async function getData() {
  ...
  const data = await fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=${city_name1}&units=metric&appid=${key}`,
  );
  ...
  try {
    ...
    function check() {
      ...
      if (
        ...
        ((hours1 >= 0 && hours1 < 6) || (hours1 >= 19 && hours1 < 24))
      ) {
        img = `svgs/moon.svg`;
    ...
    body.innerHTML = `<div class="time_name">
                <div class="cloud"><img src= ${img} alt="NO IMAGE"></div>
                <div class="time">
